    ...
    <div>
        ...
        @if ($type === 'popular')
            ...
            <div class="pagination">
                @if ($current > 1)
                    <a class="movie-btn" href="{{ route('get', ['type' => $type, 'page' => $current - 1]) }}">
                        Précédent
                    </a>
                @endif
                @if ($current < $maxPage)
                        ...
                        <div class="movie-card">
                            <div class="content-card">
                                ...
                                <div class="content">
                                    ...
                                    <form action="{{ Route('store', ['type' => 'movie']) }}" method="POST">
                                        @csrf
        ...
        @else
            ...
            <p>Les séries les mieux notés</p>
